...
void VertexBuffer::BindBuffer(u32 index, u32 bufSize, u32 stride)
{
    GX2SetAttribBuffer(index, bufSize, stride, buffer);
}

void VertexBuffer::BindExtBuffer(u32 index, u32 bufSize, u32, u32 stride, void* buffer)
{
    GX2SetAttribBuffer(index, bufSize, stride, buffer);
}
